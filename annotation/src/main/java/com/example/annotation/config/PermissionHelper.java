...
import com.example.annotation.service.AbstractDataAuthService;
...
public class PermissionHelper extends AbstractDataAuthService implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        // 组装新的 sql
        String newSql = this.splicingSql(boundSql.getSql(), annotation);
        // 重新new一个查询语句对象
